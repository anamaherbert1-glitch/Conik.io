...
type Props = { slug?: string; liveId?: string; host?: boolean }

export default function LiveChat({ slug, liveId, host = false }: Props) {
  ...
  return <section className="panel" style={{ display: 'flex', flexDirection: 'column', minHeight: 420 }}>
    <div style={{ borderBottom: '1px solid var(--line)', paddingBottom: 12 }}><h3 style={{ margin: 0 }}>Chat du Live</h3><span className="muted" style={{ fontSize: 12 }}>Les messages des participants apparaissent ici.</span></div>
