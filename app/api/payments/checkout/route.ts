...
/** Crée une commande pending (branchement API Wave/CinetPay à venir) */
export async function POST(request: Request) {
  ...
  return NextResponse.json({
    order,
    message: 'Commande enregistrée. Le paiement réel via le prestataire sera branché à l’étape suivante.',
  }, { status: 201 })
}
