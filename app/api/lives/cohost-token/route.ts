...
export async function POST(request: Request) {
  try {
    ...
    const supabaseKey = process.env.NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY || process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || SUPABASE_PUBLISHABLE_KEY_FALLBACK
    ...
    accessToken.addGrant({ roomJoin: true, room: live.room_name, canPublish: true, canSubscribe: true, canPublishData: true })
