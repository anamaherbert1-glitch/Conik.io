...
export default async function WhatsAppPage() {
  ...
  return <AppShell active="WhatsApp">
    <header><div><small>WHATSAPP BUSINESS</small><h1>WhatsApp</h1><p className="muted">Connexion Cloud API, GREEN-API, conversations, templates et automatisations.</p></div></header>
