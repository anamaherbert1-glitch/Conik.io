...
function NewFunnelInner() {
  ...
  async function importProject(event: FormEvent) {
    ...
    try {
      ...
      if (!response.ok) throw new Error(data.error || "Échec de l'import du projet.")
      setProgress(
    ...
    return (
      <div className="page funnel-new-page">
        ...
        <p className="funnel-new-intro">
          ...
          vidéos, audio et polices. Conik recrée un tunnel multi-pages avec navigation interne, assets
          hébergés et scripts préservés — sans casser le système de paiement Conik.
        </p>
            ...
            <label className="form-label">
              ...
              >
                ...
                <small className="muted">
                  Ex. index.html, about.html, css/, js/, images/, videos/ — max 25 Mo
                </small>
              </div>
              <input
                ref={fileRef}
        ...
        <p className="muted" style={{ marginTop: 20, maxWidth: 640, lineHeight: 1.6 }}>
          Après l’import, ouvrez l’éditeur pour ajuster les redirections, la photo de partage ou brancher un
          bouton de paiement Conik (<code>data-conik-payment</code>).
        </p>
  ...
  return (
    <div className="page funnel-new-page">
      ...
      <p className="funnel-new-intro">
        Commencez simplement : donnez un nom à votre tunnel. Vous pourrez ensuite créer ses pages et importer
        votre HTML ou votre ZIP depuis l’éditeur. Pour un site multi-pages complet, utilisez{' '}
