...
export default function SignupPage() {
  ...
  async function submit(event: FormEvent) {
    ...
    try {
      ...
      const { data, error } = await supabase.auth.signUp({ email: normalizedEmail, password, options: { emailRedirectTo: `${window.location.origin}/auth/callback?next=/onboarding` } })
