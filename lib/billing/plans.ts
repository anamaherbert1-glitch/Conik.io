...
export const PLANS: PlanDefinition[] = [
  {
    ...
    priceAnnualEur: 0,
    limits: {
      tunnels: 1, pagesPerTunnel: 3, importsHtmlPerMonth: 1, importZip: false, importMaxMb: 5,
      storageMb: 100, customDomain: false, removeBranding: false, analytics: 'basic', payments: 'none',
      products: 0, whatsapp: false, automations: 'none', emailsPerMonth: 0, contacts: 100,
      live: false, liveCohosts: 0, teamSeats: 1, dataExport: false, advancedReports: false, support: 'standard',
    },
  },
  {
    code: 'basic',
    ...
    limits: {
      ...
      products: 3, whatsapp: false, automations: 'none', emailsPerMonth: 500, contacts: 2000,
      live: false, liveCohosts: 0, teamSeats: 1, dataExport: false, advancedReports: false, support: 'standard',
    },
  },
  {
    ...
    limits: {
      ...
      storageMb: 10240, customDomain: true, removeBranding: true, analytics: 'advanced', payments: 'advanced',
      products: 20, whatsapp: true, automations: 'limited', emailsPerMonth: 5000, contacts: 10000,
      live: true, liveCohosts: 3, teamSeats: 3, dataExport: true, advancedReports: true, support: 'priority',
    },
  },
  {
    code: 'business',
    ...
    limits: {
      ...
      products: 100, whatsapp: true, automations: 'advanced', emailsPerMonth: 25000, contacts: 50000,
      live: true, liveCohosts: 10, teamSeats: 15, dataExport: true, advancedReports: true, support: 'dedicated',
    },
  },
]
...
export const PLAN_COMPARISON_ROWS: Array<{ key: string; label: string; value: (p: PlanDefinition) => string }> = [
  ...
  { key: 'pay', label: 'Paiements', value: (p) => p.limits.payments === 'none' ? 'Non' : p.limits.payments === 'limited' ? 'Limité' : 'Avancé' },
  ...
  { key: 'auto', label: 'Automatisations', value: (p) => p.limits.automations === 'none' ? 'Non' : p.limits.automations === 'limited' ? 'Limitées' : 'Avancées' },
